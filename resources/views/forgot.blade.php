...
<section id="login">
        ...
        <form action="{{ route('login.authenticate') }}" method="POST" class="login">
            ...
            <div class="input-group">
                ...
                <div class="input-field">
                    <i class="fa-solid fa-lock"></i>
                    <input type="password" class="form-control" id="myInput1" name="password" placeholder="confirmer password" required/>
                ...
                <div class="btn">
                    <button class="blue" type="submit">confirmer</button>
                </div>
            </form>
        </div>
            </div>
