...
@section('content')
    <section id="home">
        ...
        <p>Discover Arti Formation, your online learning school specializing in web development and design. Explore our
    ...
    <section id="video">
        ...
        <main class="container">
            ...
            <section class="video-playlist">
                ...
                <p class="hidden">Our educational site (Arti Formation) offers simple and comprehensive lessons in different
                ...
                <p class="hidden">We offer a wide range of free Formation in various digital fields. Learn more about your
    ...
    <section id="features" class="hidden">
        ...
        <p>Here are some features of Arti Formation</p>
        <div class="fea-base">
            <div class="fea-box hidden">
                <i class="fa-solid fa-chalkboard-user"></i>
                <h3>
                    Experienced teachers </h3>
                <p>Arti Formation dispose d'une équipe d'enseignants expérimentés et d'experts dans leurs domaines
            ...
            <div class="fea-box hidden">
                ...
                <p>Arti Formation regularly updates course content to follow the latest trends in
            ...
            <div class="fea-box hidden">
                ...
                <h3>
                    Certificate</h3>
                <p>Arti Formation delivers international certificates in France following the successful completion of
                    certain courses or
